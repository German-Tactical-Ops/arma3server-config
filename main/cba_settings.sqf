...
force force A3TI_ENABLE_ZEUS = false;
...
force force A3TI_REMOVE_FILMGRAIN_RHS = false;
...
force force ace_common_swayFactor = 0.9;
...
force force ace_csw_progressBarTimeCoefficent = 0.1;
...
// ACE Explosives
force force ace_explosives_customTimerDefault = 300;
force force ace_explosives_customTimerMax = 900;
force force ace_explosives_customTimerMin = 60;
...
acex_field_rations_hudTransparency = 0;
...
force force ace_map_gestures_defaultColor = [1,0.88,0,0.500387];
force force ace_map_gestures_defaultLeadColor = [1,0.88,0,1];
...
force force ace_map_gestures_nameTextColor = [1,0.500387,0,0.500387];
...
force force ace_medical_painUnconsciousThreshold = 1;
...
force force ace_medical_windowOnWakeUp = 1;
...
force force ace_nametags_nametagColorBlue = [0.5,0.5,1,1];
force force ace_nametags_nametagColorGreen = [0.5,1,0.5,1];
ace_nametags_nametagColorMain = [1,1,1,1];
force force ace_nametags_nametagColorRed = [1,0.5,0.5,1];
force force ace_nametags_nametagColorYellow = [1,1,0.5,1];
...
force force ace_nametags_showPlayerNames = 3;
...
force force ace_nightvision_noiseScaling = 0.316375;
...
force force ace_overheating_heatCoef = 2;
force force ace_overheating_jamChanceCoef = 0.495006;
...
force force ace_overheating_suppressorCoef = 0.1;
...
// ACE Trenches
force force ace_trenches_bigEnvelopeDigDuration = 600;
force force ace_trenches_bigEnvelopeRemoveDuration = 600;
force force ace_trenches_smallEnvelopeDigDuration = 600;
force force ace_trenches_smallEnvelopeRemoveDuration = 600;
...
force force ace_hitreactions_minDamageToTrigger = 0.465651;
...
force force ace_overpressure_backblastDistanceCoefficient = 0.5;
force force ace_overpressure_overpressureDistanceCoefficient = 0.5;
...
force force ace_winddeflection_simulationInterval = 0.0994319;
...
force force crowsEW_spectrum_spectrumEnable = false;
...
force force emr_main_blacklistStr = "Land_CamoConcreteWall_01_l_4m_v1_F";
...
force force emr_main_enableWalkableSurface = false;
...
force force PDT_ENVG_Effect = "wpEffect";
...
force force TFAR_objectInterceptionStrength = 0;
...
force force TFAR_setting_defaultFrequencies_lr_west = "41,30,38";
force force TFAR_setting_defaultFrequencies_sr_east = "";
force force TFAR_setting_defaultFrequencies_sr_independent = "";
force force TFAR_setting_defaultFrequencies_sr_west = "31,32,33,34,35,36,30,38";
...
force force TFAR_Teamspeak_Channel_Name = "TFAR_Ranger";
force force TFAR_Teamspeak_Channel_Password = "rwezui";
...
force force Marbit_MarkerBHColor = "ColorBlack";
force force Marbit_MarkerBHEnabler = true;
force force Marbit_MarkerFourColor = "ColorGreen";
force force Marbit_MarkerFourEnabler = true;
force force Marbit_MarkerFourIcon = "hd_dot";
force force Marbit_MarkerFourLabel = "HM ";
force force Marbit_MarkerFourLabelPost = " ";
force force Marbit_MarkerFourLabelPostCustom = false;
force force Marbit_MarkerOneColor = "ColorRed";
force force Marbit_MarkerOneEnabler = true;
force force Marbit_MarkerOneIcon = "hd_dot";
force force Marbit_MarkerOneLabel = "HM ";
force force Marbit_MarkerOneLabelPost = " ";
force force Marbit_MarkerOneLabelPostCustom = false;
force force Marbit_MarkerThreeColor = "ColorBlack";
force force Marbit_MarkerThreeEnabler = true;
force force Marbit_MarkerThreeIcon = "hd_dot";
force force Marbit_MarkerThreeLabel = "HM ";
force force Marbit_MarkerThreeLabelPost = " ";
force force Marbit_MarkerThreeLabelPostCustom = false;
force force Marbit_MarkerTwoColor = "ColorBlue";
force force Marbit_MarkerTwoEnabler = true;
force force Marbit_MarkerTwoIcon = "hd_dot";
force force Marbit_MarkerTwoLabel = "HM ";
force force Marbit_MarkerTwoLabelPost = " ";
force force Marbit_MarkerTwoLabelPostCustom = false;
force force Marbit_MarkerZeroColor = "colorCivilian";
force force Marbit_MarkerZeroEnabler = true;
force force Marbit_MarkerZeroIcon = "hd_dot";
force force Marbit_MarkerZeroLabel = "";
force force Marbit_MarkerZeroLabelPost = "";
force force Marbit_sideMarkerCounterPre = 0;
...
force force Vcm_AISkills_General_AimingAccuracy = 0.701618;
force force Vcm_AISkills_General_aimingShake = 0.15;
force force Vcm_AISkills_General_aimingSpeed = 0.045;
force force Vcm_AISkills_General_commanding = 1;
force force Vcm_AISkills_General_courage = 1;
force force Vcm_AISkills_General_general = 1;
force force Vcm_AISkills_General_reloadSpeed = 1;
force force Vcm_AISkills_General_spotDistance = 0.7;
force force Vcm_AISkills_General_spotTime = 0.195851;
...
force force VCM_FRMCHANGE = false;
force force Vcm_GrenadeChance = 0.01;
force force VCM_HEARINGDISTANCE = 1000;
force force VCM_MEDICALACTIVE = false;
force force VCM_MINECHANCE = 0;
force force VCM_MINEENABLED = false;
force force Vcm_PlayerAISkills = false;
...
force force Vcm_SmokeGrenadeChance = 0.01;
...
force force vet_unflipping_unit_man_limit = 4;
...
force force ACM_airway_allowSurgicalAirway = 2;
...
force force ACM_disability_treatmentTimeWrapSplint = 2;
